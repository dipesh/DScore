...
public class IabHelper {
    ...
    boolean mSubscriptionUpdateSupported = true;
...
//    }
     ...
     */
    public void queryInventoryAsync(final boolean querySkuDetails, final List<String> moreSkus, final List<String> moreSubSkus,
