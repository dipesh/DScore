 ...
 */
public class ClassicBlackWatchFace extends CanvasWatchFaceService {
    /**
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<ClassicBlackWatchFace.Engine> mWeakReference;

        public EngineHandler(ClassicBlackWatchFace.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            ClassicBlackWatchFace.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
...
//        Paint mTimePaintRed;
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(ClassicBlackWatchFace.this)
            ...
            mTime = new Time();
            mGoogleApiClient = new GoogleApiClient.Builder(ClassicBlackWatchFace.this)
...
//            }
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            Resources resources = ClassicBlackWatchFace.this.getResources();
            mIsRound = insets.isRound();

            if (mIsRound) {
                Drawable backgroundDrawable = resources.getDrawable(R.drawable.classique_black_1_circle_640x640, null);
                mBackgroundBitmap = ((BitmapDrawable) backgroundDrawable).getBitmap();

                Drawable backgroundAmbientDrawable = resources.getDrawable(R.drawable.classique_black_ambient_mode_circle, null);
                mAmbientBackgroundBitmap = ((BitmapDrawable) backgroundAmbientDrawable).getBitmap();
            } else {
                Drawable backgroundDrawable = resources.getDrawable(R.drawable.classique_black_1_square_640x640, null);
                mBackgroundBitmap = ((BitmapDrawable) backgroundDrawable).getBitmap();

                Drawable backgroundAmbientDrawable = resources.getDrawable(R.drawable.classique_black_ambient_mode_square, null);
                mAmbientBackgroundBitmap = ((BitmapDrawable) backgroundAmbientDrawable).getBitmap();
            }
            ...
            mHourHand = ((BitmapDrawable) resources.getDrawable(R.drawable.classic_black_hand_hour_640, null)).getBitmap();
            mHourHand = Bitmap.createScaledBitmap(mHourHand, mWidth, mHeight, true);
            mMinuteHand = ((BitmapDrawable) resources.getDrawable(R.drawable.classic_black_hand_minute_640, null)).getBitmap();
            mMinuteHand = Bitmap.createScaledBitmap(mMinuteHand, mWidth, mHeight, true);
            mSecondHand = ((BitmapDrawable) resources.getDrawable(R.drawable.classic_black_hand_second_640, null)).getBitmap();
            mSecondHand = Bitmap.createScaledBitmap(mSecondHand, mWidth, mHeight, true);
//u
//                    mHourHandAmbient = ((BitmapDrawable) resources.getDrawable(R.drawable.analog_classic_hand_hour, null)).getBitmap();
//            mHourHandAmbient = Bitmap.createScaledBitmap(mHourHandAmbient, mWidth, mHeight, true);
//            mMinuteHandAmbient = ((BitmapDrawable) resources.getDrawable(R.drawable.analog_classic_hand_minute, null)).getBitmap();
//            mMinteHandAmbient = Bitmap.createScaledBitmap(mMinuteHandAmbient, mWidth, mHeight, true);
            ...
            mTimePaint = createPaint(resources.getColor(R.color.white), 18, Paint.Align.CENTER, WALKWAY_SEMI_BOLD_SCORE);
            mTimePaintBorder = createPaint(resources.getColor(R.color.black), 18, Paint.Align.CENTER, WALKWAY_SEMI_BOLD_SCORE);
...
//            mTimePaintRed = createPaint(resources.getColor(R.color.red), 18, Paint.Align.CENTER, WALKWAY_SEMI_BOLD_SCORE);
        }
...
//            }
            ...
            drawTextWithBorder(canvas, currentGame.homeTeam.initials, 88, 138, ratio, mAnalogInitialsPaint, mAnalogInitialsPaintBorder, null);
            drawTextWithBorder(canvas, currentGame.homeTeam.score, 88, 160, ratio, mAnalogScorePaint, mAnalogScorePaintBorder, null);
            drawTextWithBorder(canvas, currentGame.awayTeam.initials, 230, 138, ratio, mAnalogInitialsPaint, mAnalogInitialsPaintBorder, null);
            drawTextWithBorder(canvas, currentGame.awayTeam.score, 230, 160, ratio, mAnalogScorePaint, mAnalogScorePaintBorder, null);
            drawTextWithBorder(canvas, currentGame.gameTimeOrStartDate, 160, 207, ratio, mTimePaint, mTimePaintBorder, null);
            drawTextWithBorder(canvas, currentGame.gameStatusOrStartTime, 160, 224, ratio, mTimePaint, mTimePaintBorder, null);
...
//            }
        ...
        private void registerReceiver() {
            ...
            ClassicBlackWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            ClassicBlackWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
