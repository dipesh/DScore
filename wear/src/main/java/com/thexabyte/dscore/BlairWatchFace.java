 ...
 */
public class BlairWatchFace extends CanvasWatchFaceService {
    /**
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<BlairWatchFace.Engine> mWeakReference;

        public EngineHandler(BlairWatchFace.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            BlairWatchFace.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
    ...
    private class Engine extends CanvasWatchFaceService.Engine implements DataApi.DataListener,
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(BlairWatchFace.this)
            ...
            mTime = new Time();
            mGoogleApiClient = new GoogleApiClient.Builder(BlairWatchFace.this)
...
//            }
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            Resources resources = BlairWatchFace.this.getResources();
            mIsRound = insets.isRound();

            Drawable backgroundDrawable = resources.getDrawable(R.drawable.blair_square_640x640, null);
            mBackgroundBitmap = ((BitmapDrawable) backgroundDrawable).getBitmap();
            mBackgroundBitmap = Bitmap.createScaledBitmap(mBackgroundBitmap, mWidth, mHeight, true);

            //Drawable backgroundAmbientDrawable = resources.getDrawable(R.drawable.blair_square_640x640, null);
            ...
            mHourHand = ((BitmapDrawable) resources.getDrawable(R.drawable.blair_hand_hour_640x640, null)).getBitmap();
            mHourHand = Bitmap.createScaledBitmap(mHourHand, mWidth, mHeight, true);
            mMinuteHand = ((BitmapDrawable) resources.getDrawable(R.drawable.blair_hand_minute_640x640, null)).getBitmap();
            mMinuteHand = Bitmap.createScaledBitmap(mMinuteHand, mWidth, mHeight, true);
            mSecondHand = ((BitmapDrawable) resources.getDrawable(R.drawable.blair_hand_second_640x640, null)).getBitmap();
            ...
            mTextPaint = createPaint(resources.getColor(R.color.white), 28, Paint.Align.CENTER, FRESHMAN);
            mBorderTextPaint = createPaint(resources.getColor(R.color.black), 28, Paint.Align.CENTER, FRESHMAN);
...
//            }
        ...
        private void registerReceiver() {
            ...
            BlairWatchFace.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            BlairWatchFace.this.unregisterReceiver(mTimeZoneReceiver);
        }
